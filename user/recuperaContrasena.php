...
Swal.fire({
  ...
  ?>
    ...
    <main role="main" class="container my-auto">
                ...
                <form method='post' action='<?php $_SERVER["PHP_SELF"]; ?>' autocomplete='off'>
                    ...
                    <div class="input-group">
                        <div class="input-group-append ">
                            <button class="btn btn-light"> <i class="icon-mail"
                                    style="color:red; font-size:23px;"></i></button>
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <button type="submit" class="btn btn-warning form-control font-weight-bold"><i
                                class="icon-unlocked1 text-primary"></i> Recuperar</button>
                    </div>
                </form>
        ...
        ?>
                <a class="font-weight-bold" href="../index.php"><span class="icon-user text-danger"></span> Iniciar
                    Sessión</a>
            </div>
