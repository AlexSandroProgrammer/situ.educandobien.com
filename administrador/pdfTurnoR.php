...
<div style="margin-top: -100px;">
    ...
    <h1 align="center" style="font-weight: bold;"> <?php if (isset($busqueda)) {
                                                      echo "Busqueda";
                                                    } else {
                                                      echo "Lista";
                                                    } ?> de Turnos Rutinarios</h1>
    <table width="500" class="" style=" margin-top: 60px;" align="center">
      ...
      ?>
        ...
        <tr align='center' class='font-weight-bold' scope='row'>
            <td style="border: black;font-size: 14px;height: 25px; width: 20px;"><?php echo $fila['id_aprendiz']; ?>
            </td>
            ...
            <td style="border: black;font-size: 12px;height: 55px; width: 50px;" align="center">
                <?php echo $fila['nombreUnidad']; ?></td>
            ...
            <td style="border: black;font-size: 14px;height: 25px; width: 20px;"><?php echo $fila['horaInicioM']; ?>
            </td>
            <td style="border: black;font-size: 14px;height: 25px; width: 20px;"><?php echo $fila['horaFinM']; ?></td>
            <?php if ($tipoTurno == '15 dias') {

          ?>
            <td style="border: black;font-size: 14px;height: 25px; width: 20px;"><?php if (isset($fila['horaInicioT'])) {
                                                                                    echo $fila['horaInicioT'];
                                                                                  } else {
                                                                                    echo "No tiene Turno en la Tarde";
                                                                                  } ?></td>
            <td style="border: black;font-size: 14px;height: 25px; width: 20px;"><?php if (isset($fila['horaFinT'])) {
                                                                                    echo $fila['horaFinT'];
                                                                                  } else {
                                                                                    echo "No tiene Turno en la Tarde";
                                                                                  } ?></td>
