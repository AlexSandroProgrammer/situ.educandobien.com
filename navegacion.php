                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav mr-auto">
                        ...
                        <li class="nav-item dropdown" style="margin-left: 120px;">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left animated flipInY">
                                <a href="../administrador/listarAprendices.php"
                                    class="dropdown-item font-weight-bold text-dark">
                                    <i class=""></i> Listar Aprendices
                                </a>
                                <div class="dropdown-divider"></div>

                                <a href="../administrador/listarFichas.php"
                                    class="dropdown-item font-weight-bold text-dark">
                                    <i class=""></i> Listar Fichas
                                </a>
                                <div class="dropdown-divider"></div>
                                <a href="../administrador/listarProgramas.php"
                                    class="dropdown-item font-weight-bold text-dark">
                        ...
                        <li class="nav-item dropdown" style="margin-left: 120px;">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left animated flipInY">
                                <a href="../administrador/listaTurnosRutinario.php"
                                    class="dropdown-item font-weight-bold text-dark">
                                    <div class=""><i class="" style="font-size: 20px;"></i></div> Turnos Rutinarios
                                </a>
                                <div class="dropdown-divider"></div>

                                <a href="../administrador/listarTurnosEspeciales.php"
                                    class="dropdown-item font-weight-bold text-dark">
                                    <i class=""></i> Turnos Especiales
                                </a>
                                <div class="dropdown-divider"></div>
                                <a href="../administrador/TurnosAutomaticos.php"
                                    class="dropdown-item font-weight-bold text-dark">
